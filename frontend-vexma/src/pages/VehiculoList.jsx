                            ...
                            <td>
                                ...
                                {/*Vender o reingresar (segun fechaEgreso)
                                {
                                    vehiculo.fechaEgreso == null ? (
                                        <button style={{marginRight:"5px"}} title="Vender vehículo">
                                            <FaMoneyBillWave color="green"/>
                                        </button>
                                    ) : (
                                        <button style={{marginRight:"5px"}} title="Reingresar vehículo">
                                            <FaUndo color="orange"/>
                                        </button>
                                    )
                                }*/}
                                ...
                                {/*Borrar*/}
                                <button onClick={() => borrarVehiculo(vehiculo.id)} style={{marginRight:"5px"}} title="Borrar vehículo">
                                    <FaTrash color="red"/>
                                </button>
                            </td>
                        </tr>
